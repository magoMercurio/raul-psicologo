...
const Hero = () => {
    ...
    return (
      <section className="  flex flex-col justify-center items-center  mb-0 " id="home">
        <span className="custom-block-big-title text-customLightBg3 break-words text-center text-sm sm:text-base   font-bold mt-20 mb-20 ml-20 mr-20 " >Bienvenido/a a un espacio  crecimiento personal y de sanación, donde encontrarás el apoyo y la guía necesarios para alcanzar tu bienestar emocional.</span>
